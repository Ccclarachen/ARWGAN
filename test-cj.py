...
def main():
    ...
    parser.add_argument('--save-dir', '-d', required=True, type=str, help='Directory to save processed images')
    ...
    for source_image in source_images:
        ...
        save_path = os.path.join(args.save_dir, f'test-{os.path.splitext(source_image)[0]}.jpg')
        utils.save_images(image_tensor.cpu(), encoded_images.cpu(), 0, save_path, resize_to=(128, 128))
